<?php
class TrustindexPlugin_facebook
{
...
$review['rating'] = $review['recommendation_type'] === 'negative' ? 1 : 5;
}
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-11.8.4", "do-not-care-Widgets for Reviews & Recommendations", "do-not-care-Facebook");
